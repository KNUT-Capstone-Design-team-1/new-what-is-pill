...
parser.add_argument('--trained_model', default='C:\\Users\\jinte\\Desktop\\what_is_pill_app\\new-what-is-pill\\deeplearning-server\\weights\\craft_mlt_25k.pth', type=str, help='pretrained model')
...
def detect_text_img(pill_image):
