...
def detect_pill_shape(img_data):
    ...
    #학습된 모델 불러오기
    model.load_state_dict(torch.load('C:\\Users\\jinte\\Desktop\\what_is_pill_app\\new-what-is-pill\\deeplearning-server\\weights\\pill_shape_fine_tuned.pt', map_location='cpu'))
    model.eval()
